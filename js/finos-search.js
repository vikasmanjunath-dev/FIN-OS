...
(function () {
  ...
  const INDEX = [
    ...
    { title:'Live Tracker',      desc:'Real-time stock, crypto and market data feed',                         url:'../html/stock-platform.html',   cat:'Pages',       tags:['stocks','live','market','crypto','nifty','sensex','price'] },
